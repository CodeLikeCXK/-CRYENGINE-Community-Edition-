if (NOT EXISTS "${CRYENGINE_DIR}/Tools/branch_bootstrap/bootstrap.exe")
    if (OPTION_ENGINE OR NOT PROJECT_BUILD)
	    ...
	    if (NOT EXISTS "${SDK_DIR}" OR DEFINED FORCE_EXTRACT_SDKS)
	    	...
	    	message("Extracting ${SDK_ARCHIVE} to ${SDK_DIR}/...")
			# CMake 4 no longer accepts the legacy tar flags used here. The
			# archive format is detected from the .zip extension.
			execute_process(COMMAND "${CMAKE_COMMAND}" "-E" "tar" "xf" "${CRYENGINE_DIR}/${SDK_ARCHIVE}" WORKING_DIRECTORY "${SDK_DIR}")
