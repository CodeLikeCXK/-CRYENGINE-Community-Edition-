...
struct RowExpander
{
	...
	ScanResult operator()(PropertyRow* row, PropertyTreeLegacy* tree, int index)
	{
...
void PropertyTreeModel::YASLI_SERIALIZE_METHOD(Archive& ar, PropertyTreeLegacy* tree)
{
