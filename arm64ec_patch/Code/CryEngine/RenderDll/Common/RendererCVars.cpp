...
float CRendererCVars::CV_r_TextureSharpening;

float CRendererCVars::CV_r_Vibrance;
...
int CRendererCVars::CV_r_DXRReflectionsEnabled;
float CRendererCVars::CV_r_DXRReflectionsMaxDist;
float CRendererCVars::CV_r_DXRReflectionsRoughThreshold;
int CRendererCVars::CV_r_DXRReflectionsMaxBounces;
int CRendererCVars::CV_r_DXRSpecularEnabled;
float CRendererCVars::CV_r_DXRSpecularStrength;
int CRendererCVars::CV_r_DXRSpecularSamples;
int CRendererCVars::CV_r_DXRDiffuseEnabled;
float CRendererCVars::CV_r_DXRDiffuseStrength;
int CRendererCVars::CV_r_DXRDiffuseSamples;
...
void CRendererCVars::InitCVars()
{
	...
	REGISTER_CVAR3("r_DeferredShadingTiled", CV_r_DeferredShadingTiled, 2, VF_DUMPTODISK,
	...
	REGISTER_CVAR3("r_TextureSharpening", CV_r_TextureSharpening, 0.0f, VF_NULL,
		"Texture sharpening amount\n"
		"Usage: r_TextureSharpening [Value]");

	REGISTER_CVAR3("r_Vibrance", CV_r_Vibrance, 0.0f, VF_NULL,
		"Image vibrance amount\n"
		"Usage: r_Vibrance [Value]");
	...
	REGISTER_CVAR3("r_DXRReflectionsEnabled", CV_r_DXRReflectionsEnabled, 0, VF_NULL, "Enables ray traced reflections\n"
		"0: Disabled\n"
		"1: Enabled\n");

	REGISTER_CVAR3("r_DXRReflectionsMaxDist", CV_r_DXRReflectionsMaxDist, 50.0f, VF_NULL, "Maximum distance for ray traced reflections (in meters)");

	REGISTER_CVAR3("r_DXRReflectionsRoughThreshold", CV_r_DXRReflectionsRoughThreshold, 0.5f, VF_NULL, "Surface roughness threshold above which ray traced reflections are not used");

	REGISTER_CVAR3("r_DXRReflectionsMaxBounces", CV_r_DXRReflectionsMaxBounces, 1, VF_NULL, "Maximum number of ray bounces for reflections");

	REGISTER_CVAR3("r_DXRSpecularEnabled", CV_r_DXRSpecularEnabled, 1, VF_NULL, "Enables ray traced specular reflections\n"
            "0: Disabled\n"
            "1: Enabled\n");

	REGISTER_CVAR3("r_DXRSpecularStrength", CV_r_DXRSpecularStrength, 1.0f, VF_NULL, "Strength multiplier for ray traced specular reflections");

	REGISTER_CVAR3("r_DXRSpecularSamples", CV_r_DXRSpecularSamples, 1, VF_NULL, "Number of samples per pixel for specular reflections");

	REGISTER_CVAR3("r_DXRDiffuseEnabled", CV_r_DXRDiffuseEnabled, 0, VF_NULL, "Enables ray traced diffuse reflections (global illumination)\n"
            "0: Disabled\n"
            "1: Enabled\n");

	REGISTER_CVAR3("r_DXRSpecularSamples", CV_r_DXRSpecularSamples, 1, VF_NULL, "Number of samples per pixel for diffuse reflections");

	REGISTER_CVAR3("r_DXRDiffuseStrength", CV_r_DXRDiffuseStrength, 1.0f, VF_NULL, "Strength multiplier for ray traced diffuse reflections (GI)");
