...
#if defined(ARM64EC) || defined(_ARM64EC) || defined(_M_ARM64EC)
	// ARM64EC exposes the x64 ABI to source code, but executes ARM
	// instructions. Keep x64 platform branches for ABI/API compatibility and
