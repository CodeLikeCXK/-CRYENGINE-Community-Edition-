...
// ARM64EC has no x86 SIMD ABI. Keep the vector API available through scalar
// aliases so code using the generic CryMath types remains portable.
using f32v4 = f32;
using i32v4 = int32;
using u32v4 = uint32;
using mask32v4 = bool;
...
#if !CRY_PLATFORM_SSE2
template<typename S> ILINE vector4_t<S> to_v4(S s) { return s; }
#endif
