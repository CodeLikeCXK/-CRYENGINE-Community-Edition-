...
YASLI_ENUM(EPlatform::WindowsARM64EC, "win_arm64ec", "win_arm64ec")
		...
		struct SContent
		{
			struct SLibrary
			{
				struct SShared
				{
					void Serialize(Serialization::IArchive& ar)
					{
						...
						ar(libPathArm64EC, "win_arm64ec", "win_arm64ec");
						ar(libPathWin32, "win_x86", "win_x86");
					}

					string libPathAny;
					string libPathWin64;
					string libPathArm64EC;
					string libPathWin32;
				};
			...
			void Serialize(Serialization::IArchive& ar)
			{
				if (ar.isOutput())
				{
					...
					libraries[0].shared.libPathArm64EC = project.legacyGameDllPaths["win_arm64ec"];
				...
				if (ar.isInput())
				{
					...
					if (!libraries.empty())
					{
						...
						project.legacyGameDllPaths["win_arm64ec"] = libraries[0].shared.libPathArm64EC;
