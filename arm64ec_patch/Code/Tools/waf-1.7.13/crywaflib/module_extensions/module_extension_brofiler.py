...
def module_extensions_brofiler(ctx, kw, entry_prefix, platform, configuration):
	...
	if platform == 'win_x86' or platform == 'win_x64' or platform == 'win_arm64ec':
		...
		profiler_name = profiler_name + ('64' if platform != 'win_x86' else '32')
...
def feature_copy_brofiler_binaries(self):
	...
	if platform.startswith("win"):
		...
		easyhook_name = easyhook_name + ('64' if platform != 'win_x86' else '32')
		brofilerCore_name = brofilerCore_name + ('64' if platform != 'win_x86' else '32')
