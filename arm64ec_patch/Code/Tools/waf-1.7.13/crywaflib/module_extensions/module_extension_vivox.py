...
def feature_copy_vivox_api_binaries(self):
	...
	bin_location = {'win_x64' : ['x64/bin/vivoxplatform.dll', 'x64/bin/vivoxsdk_x64.dll', 'x64/bin/ortp_x64.dll', 'x64/bin/ortp_x64.pdb', 'x64/bin/vivoxplatform.pdb', 'x64/bin/vivoxsdk_x64.pdb'], 'win_arm64ec' : ['x64/bin/vivoxplatform.dll', 'x64/bin/vivoxsdk_x64.dll', 'x64/bin/ortp_x64.dll', 'x64/bin/ortp_x64.pdb', 'x64/bin/vivoxplatform.pdb', 'x64/bin/vivoxsdk_x64.pdb']}
